---
{"dg-publish":true,"permalink":"/quickstart/","dg-note-properties":{}}
---
...
| I want to… | Go to |
|---|---|
| Make the evaluations feel more accurate | [How to customize the system to your career](how-to-guides/customize-the-system.md) |
| Understand what the score and each block mean | [Scoring system reference](reference/scoring-system.md) |
| Search dozens of company job pages automatically | [How to scan job portals](how-to-guides/scan-job-portals.md) |
| Evaluate 10+ jobs in parallel | [How to batch-evaluate offers](how-to-guides/batch-evaluate-offers.md) |
| See all available commands | [Commands reference](reference/commands.md) |
