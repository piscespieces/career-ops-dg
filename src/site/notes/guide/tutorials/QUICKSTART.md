---
{"dg-publish":true,"permalink":"/guide/tutorials/quickstart/","dg-note-properties":{}}
---

# Quick Start: Your First Job Evaluation
...
- **Contribute a fix:** If you know how to fix the issue yourself, read [CONTRIBUTING.md](../../CONTRIBUTING.md) before opening a pull request. The short version: open an issue first to discuss the change, then submit your PR.

---

## Next steps

You have completed the Quick Start. Here is what to read next depending on what you want to do:

| I want to… | Go to |
|---|---|
| Make the evaluations feel more accurate | [How to customize the system to your career](customize-the-system.md) |
| Understand what the score and each block mean | [Scoring system reference](scoring-system.md) |
| Search dozens of company job pages automatically | [How to scan job portals](scan-job-portals.md) |
| Evaluate 10+ jobs in parallel | [How to batch-evaluate offers](batch-evaluate-offers.md) |
| See all available commands | [Commands reference](commands.md) |
| Full setup options | [Setup Guide](../../docs/SETUP.md) |

For a deeper look at all the commands right now, see the [Setup Guide](../../docs/SETUP.md). To customize the scoring system, archetypes, and negotiation scripts, just ask Claude Code — it can edit its own configuration files on your behalf.
